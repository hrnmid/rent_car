...
<head>
    <meta charset="utf-8" />
    <title>Login| Indobox Asia Pte Ltd</title>
    <meta name="description" content="Login page example" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    <link rel="canonical" href="https://indoboxasia.com" />
    <!--begin::Fonts-->
...
/* Gaya untuk perangkat seluler (lebar layar <= 767px) */
@media only screen and (max-width: 767px) {
    body {
        overflow: auto; /* Mengizinkan scroll pada perangkat seluler */
    }
}
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
        ...
        <a href="#" class="text-center mb-10">
            <img src="images/inba_logo.png" class="max-h-250px" alt="">
        </a>
        <!--end::Aside header-->
        <!--begin::Aside title-->
    ...
    <div class="aside-img d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center"
        style="background-image: url(images/indoboxlog3.png); background-size: contain; height: 50vh; margin-top: -25px;"></div>
    <!--end::Aside Bottom-->
</div>
            <div
                ...
                <div class="d-flex flex-column-fluid flex-center">
                    ...
                    <div class="login-form login-signin">
                        ...
                        <form action="{{ route('authenticate') }}" method="post">
                            ...
                            <div class="form-group">
                                <input
                                    class="form-control form-control-solid h-auto py-6 px-6 rounded-lg @error('email') is-invalid @enderror form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6"
                                    id="email" name="email" value="{{ old('email') }}" type="email" placeholder="Email"
                    ...
                    {{-- <div class="login-form login-forgot">
                        ...
                        <form action="{{ route('authenticate') }}" method="post">
                            ...
                            <div class="form-group">
                                <input
                                    class="form-control @error('email') is-invalid @enderror form-control-solid h-auto py-6 px-6 rounded-lg font-size-h6"
                                    id="email" name="email" value="{{ old('email') }}" type="email" placeholder="Email"
                                    name="email" autocomplete="off" />
                ...
                <div class="d-flex justify-content-lg-start justify-content-center align-items-end py-7 py-lg-0">
                    <div class="text-dark-50 font-size-lg font-weight-bolder mr-10">
                        ...
                        <a href="https://indoboxasia.com" target="_blank"
                            class="text-dark-75 text-hover-primary">Indobox Asial Pte Ltd</a>
                    </div>
                    <a href="#" class="text-primary font-weight-bolder font-size-lg">Track Shipment</a>
                    <a href="#" class="text-primary ml-5 font-weight-bolder font-size-lg">Find Rates</a>
