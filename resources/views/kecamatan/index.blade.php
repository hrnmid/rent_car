...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Kecamatan</h5>
            <!--end::Title-->
            <!--begin::Separator-->
...
<div class="card card-custom gutter-b">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">List Kecamatan</h3>
        </div>
        ...
        <div class="card-toolbar">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <a href="{{ route('kecamatan.vcreate') }}" class="add_link btn btn-primary font-weight-bolder">
            ...
            list_tbl = $("#list_tbl").DataTable({
                ...
                , columnDefs: [{
                        ...
                        , render: function(data, type, full, meta) {
                            var linkedit = "{{route('kecamatan.vedit',':id')}}";
                            linkedit = linkedit.replace(":id", data);

                            var linkdelete = "{{route('kecamatan.vdestroy',':id')}}";
