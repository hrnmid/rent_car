...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Mobil</h5>
            <!--end::Title-->
            <!--begin::Separator-->
...
<div class="card card-custom gutter-b">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">List Mobil</h3>
        </div>
        ...
        <div class="card-toolbar">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <a href="{{ route('mobil.vcreate') }}" class="add_link btn btn-primary font-weight-bolder">
  	...
  	<'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7 dataTables_pager'lp>>`,
                ...
                , columns: [{
                    ...
                    render: function(data, type, full, meta) {
                        return '<img src="' + data + '" alt="Mobil Image" style="max-width:120px; max-height:110px;">';
                    }
                }, {
                    data: "name"
                    , name: "name"
                    ...
                    render: function(data, type, row) {
                        if(data == 1) {
                            ...
                            return '<span class="badge badge-warning">Perawatan</span>';
                        } else {
                    ...
                    name: "sewa",
                    render: function(data, type, row) {
                        var sewaHarian = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(row.sewa_harian);
                        var sewaMingguan = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(row.sewa_mingguan);
                        var sewaBulanan = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(row.sewa_bulanan);
                        
                        return 'Harian: ' + sewaHarian + '<br>Mingguan: ' + sewaMingguan + '<br>Bulanan: ' + sewaBulanan;
                    }
                } ]
                , columnDefs: [{
                        targets: 0
                        ...
                        , orderable: false
                        , render: function(data, type, full, meta) {
                            var linkedit = "{{route('mobil.vedit',':id')}}";
                            linkedit = linkedit.replace(":id", data);

                            var linkdelete = "{{route('mobil.vdestroy',':id')}}";
