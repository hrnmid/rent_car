...
@section('content')
{{ Form::model($post, ['route' => ['mobiltype.vstore'], 'method' => 'post', 'id' => 'mobiltype-form']) }}
<div class="card">
    ...
    <div class="modal-body">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <div class="col-md-12">
                    {!! Form::label('name', 'Type Mobil', ['class' => 'form-control-label']) !!}
        ...
        $.ajax({
            ...
            , success: function(data) {
                ...
                if (data['success']) {
                    ...
                    var $input = $('#mobiltype-form input, #mobiltype-form textarea');
                    $input.each(function() {
