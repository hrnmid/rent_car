...
@section('content')
{{ Form::model($post, ['route' => ['transaksi.vstore'], 'method' => 'post', 'id' => 'transaksi-form', 'enctype' => 'multipart/form-data']) }}
<div class="card">
    ...
    <div class="modal-body">
        ...
        <div class="card-body">
            ...
            <div class="card-title">
                <h3 class="card-label"><i class="fa fa-paper-plane"></i>  Customer Information</h3>
            </div>
            {{-- <hr style="border-top: 1px solid #000;"> --}}
            <hr>
            <div class="col-md-4 offset-md-4">
                <div class="d-flex justify-content-between align-items-center mb-1">
                    <label class="font-weight-bold font-size-lg text-right mt-2">Choose Customer</label>
                    <a type="button" class="btn btn-light btn-sm btnadduser">
                        <i class="flaticon2-plus"></i> Add Customer
                    </a>
                </div>
                {!! Form::select('customer_id', \App\Models\User::pluck('name', 'id'), null, ['id' => 'customer_id', 'class' => 'form-control', 'placeholder' => 'Select Customer']) !!}
            </div>

            <div class="form-group row mt-4">
                <div class="col-md-6">
                    {!! Form::label('customer_name', 'Name Customer', ['class' => 'form-control-label']) !!}
                    {!! Form::text('customer_name', old('customer_name', isset($post) ? $post->customer_name : ''),
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    {!! Form::text('customer_phone', old('customer_phone', isset($post) ? $post->customer_phone : ''),
                ...
                <div class="col-md-4">
                    ...
                    {!! Form::text('customer_email', old('customer_email', isset($post) ? $post->customer_email : ''),
                ...
                <div class="col-md-4">
                    ...
                    {!! Form::textarea('customer_address', old('customer_address', isset($post) ? $post->customer_address : ''), [
            ...
            <div class="form-group row">
                <div class="col-md-4">
                    ...
                    {{ Form::select('customer_kecamatan', \App\Models\Kecamatan::where('is_active', 1)->pluck('name', 'id'),
                        old('customer_kecamatan', isset($post) ? $post->customer_kecamatan : null),
                        [
                            'id' => 'kecamatan',
                ...
                <div class="col-md-4">
                    ...
                    {{ Form::select('customer_kelurahan', \App\Models\Kelurahan::where('is_active', 1)->pluck('name', 'id'),
                        old('customer_kelurahan', isset($post) ? $post->customer_kelurahan : null),
                        [
                            'id' => 'kelurahan',
                ...
                <div class="col-md-4">
                    ...
                    {!! Form::text('customer_kodepos', old('customer_kodepos', isset($post) ? $post->customer_kodepos : ''), [
            ...
            <div class="card-title mt-10">
                <h3 class="card-label"><i class="fa fa-paper-plane"></i>  Cars Information</h3>
            </div>
            <hr>
            <div class="col-md-4 offset-md-4">
                <div class="d-flex justify-content-between align-items-center mb-1">
            ...
            <div class="card-title mt-10">
                <h3 class="card-label"><i class="fa fa-paper-plane"></i>  Booking Information</h3>
            </div>
            <hr>
            <div class="form-group row mt-4">
                <div class="col-md-3">
            ...
            <div class="card-title mt-10">
                <h3 class="card-label"><i class="fa fa-paper-plane"></i>  Invoice Information</h3>
            </div>
            <hr>
            <div class="form-group row mt-4">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    {!! Form::date('invoice_due', old('invoice_due', isset($post) ? $post->invoice_due : ''),
                        ['class' => "form-control". ( $errors->has('invoice_due') ? ' is-invalid' : '' )]) !!}
                    <div class="fv-plugins-message-container">
...
<script type="text/javascript">
    ...
    $('#mobil_id').on('change', function() {
            ...
            if (mobilId) {
                $.ajax({
                    url: '/mobils/' + mobilId, // Adjust the URL as needed
                    type: 'GET',
                    success: function(data) {
                        if (data) {
            ...
            success: function(data) {
                ...
                if (data['success']) {
                    ...
                    Swal.fire({
                        ...
                        window.location.href = 'transaksi/vdetail/' + data['data']['id'];
                    });
