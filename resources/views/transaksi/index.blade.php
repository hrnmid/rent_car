...
<div class="card card-custom gutter-b">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            <button id="printButton" class="btn btn-secondary font-weight-bolder">
                <i class="fa fa-print"></i>
                Print
            </button>
            <span style="margin-left: 10px;"></span> <!-- Memberikan jarak antara tombol -->
    ...
    <div class="card-body">
        <form id="search-frm">
            <div class="row">
                <div class="col-lg-6 col-xs-6 row">
                ...
                <div class="col-lg-3 col-xs-3">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-control-solid" placeholder="Pilih rentang tanggal" id="datetime" readonly/>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#printButton").on("click", function() {
                var dateRange = $("#datetime").val();
                if (dateRange) {
                    window.open("{{ route('transaksi.print') }}?datetime=" + dateRange, "_blank");
                } else {
                    alert("Silakan pilih rentang tanggal sebelum mencetak.");
                }
            });
        });
        function initData() {
            // Memeriksa apakah elemen sudah memiliki DataTable
            if ($.fn.DataTable.isDataTable('#list_tbl')) {
                list_tbl.destroy(); // Menghancurkan instansi DataTable sebelumnya
            }
            list_tbl = $("#list_tbl").DataTable({
                ...
                , columns: [{
                    ...
                    render: function(data, type, row) {
                        var linkshow = "{{ route('transaksi.vdetail', ':id') }}";
        ...
        // Inisialisasi Date Range Picker tanpa nilai default
        $("#datetime").daterangepicker({
            timePicker: true,
            autoUpdateInput: false, // Agar input tidak terisi otomatis
            locale: {
                format: "YYYY/MM/DD",
                cancelLabel: 'Clear' // Menambahkan tombol untuk mengosongkan pilihan
            }
        });

        // Event handler untuk saat tanggal dipilih
        ...
        // Event handler untuk saat tanggal dihapus
